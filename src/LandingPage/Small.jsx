...
const Small = () => {
  return (
    <div className='absolute bg-white top-[50px] left-[80px]'>
       <div className='flex flex-col md:hidden  rounded-md shadow-lg justify-center items-center w-[302px] '>
            <a className='p-4 hover:text-orange-700 hover:border-b-2 hover:border-orange-400' href="">Home</a>
            <a className='p-4 hover:text-orange-700 hover:border-b-2 hover:border-orange-400' href="">Adversite</a>
            <a className='p-4 hover:text-orange-700 hover:border-b-2 hover:border-orange-400' href="">Supports</a>
            <a className='p-4 hover:text-orange-700 hover:border-b-2 hover:border-orange-400' href="">About</a>
            <div className='flex'>
           <div>
